...
export class IndependienteServicio {
  ...
  public consultarListaIndependientes (): Observable<IndependienteModelo[]> {
    return this.http.get<IndependienteModelo[]>(environment.URL_BASE + direccionesUrl.INDEPENDIENTE_CONSULTA_TODOS);
  }
